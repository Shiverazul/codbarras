...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _class_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class.element */ "./src/class.element.ts");
...
$(document).ready(function () {
    ...
    $.getJSON("A-HTML.json", function (data) {
        ddbb = data.map(element => new _class_element__WEBPACK_IMPORTED_MODULE_0__["Elemento"](element.articulo, element.codigo2, element.codprov, element.descripcion, element.precio, element.stock));
        init();
    });
});
function init() {
...
function anadirPreciodeElemento(precio, cantidad, newdescuento, totalElemento) {
    ...
    const desc = precio * (newdescuento / 100);
    //console.log(newdescuento)
    const total = (precio - desc) * cantidad;
